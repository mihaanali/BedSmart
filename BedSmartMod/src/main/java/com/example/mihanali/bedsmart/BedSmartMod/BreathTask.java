...
public class BreathTask {
    ...
    TextView tw1;
    String dt1,brt;
    public BreathTask (Context con, ListView tw, String dt) {
        this.tw = tw;
        this.context=con;
    ...
    protected String doInBackground(Void... params)
    {
        ...
        try
        {
            ...
            for(int i=0;i<l1.size();i++) {
                if(l1.get(i)!="null"){
                br=Double.parseDouble(l1.get(i).trim());
                brt=String.valueOf(br);
                l2.add("Humidity at " + l3.get(i) + " - " + brt + " percent");}
            }
